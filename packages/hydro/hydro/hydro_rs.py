"""
Augment Hydro with the power of riverscapes context
"""
import argparse
import traceback
import sys
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Hydro XML Augmenter',
    ...
    try:
        ...
        report = HydroReport(os.path.join(out_prj.project_dir, report_path), out_prj)
        report.write()
