...
def taudem(huc, flowlines_orig, orig_dem, hillshade, project_folder, flowareas_orig=None, mask_lyr_path: str = None, keep_intermediates: bool = True, reach_codes: List[str] = None, meta: Dict[str, str] = None, buffer_field: str = None):
    """[summary]
...
def main():
    ...
    try:
        if args.debug is True:
            ...
            retcode, max_obj = ThreadRun(taudem, memfile, args.huc, args.flowlines, args.dem, args.hillshade, args.output_dir, args.flowareas, args.mask, args.intermediates, reach_codes, meta)
            log.debug('Return code: {}, [Max process usage] {}'.format(retcode, max_obj))

        else:
            taudem(args.huc, args.flowlines, args.dem, args.hillshade, args.output_dir, args.flowareas, args.mask, args.intermediates, reach_codes, meta, buffer_field=args.buffer_field)
