...
<div class="row small-up-2 medium-up-3">
  ...
  <div class="column">
    <div class="card">
      <a href="https://tools.riverscapes.xyz/channel"><img align="center" src="{{ site.baseurl }}/assets/images/tools/ChannelArea_Tile.png"></a>
      <div class="card-section">
        <h4>Channel Area</h4>
        <p>The <a href="https://tools.riverscapes.xyz/channel"><b>Channel Area Tool</b></a>  tool generates polygons representing the active channel network within a watershed. <img src="{{ site.baseurl }}/assets/images/rc/RiverscapesCompliant_24.png"></p>
      </div>
    </div>
  </div>
