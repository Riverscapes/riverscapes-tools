...
|---|---|---|---|
|flowlines|Geopackage Feature Class|The NHD flow lines, road and rail|[Riverscapes Context](https://tools.riverscapes.net/rscontext/data/#NETWORK_SEGMENTED)|
...
|`approx_len`|m|Approximate length of channel|
|`confin_len`|m|Length of channel abutting a confining margin|
|`constr_len`|m|Length of channel confined on both sides simultaneously|
...
|`approx_len`|m|Approximate length of channel within the polygon|
|`confin_len`|m|Length of channel abutting a confining margin within the polygon|
|`constr_len`|m|Length of channel confined on both sides simultaneously within the polygon|
...
|`approx_len`|m|Approximate length of channel within the window|
|`confin_len`|m|Length of channel abutting a confining margin within the window|
|`constr_len`|m|Length of channel confined on both sides simultaneously within the window|
