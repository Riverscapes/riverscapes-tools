...
![ss](/img/hydro/stats_fig.png)

Figure 1. The different geohydrologic regions used by StreamStats to calculate regression equations in Utah. This figure was pulled from a USGS report by Wilkowske et. Al, 2011. 
