...
<ToolsWrapper
  cards={[
    {
      title: "Data",
      description: "Discover RCAT model runs available in the Riverscapes Data Exchange.",
    ...
    {
      title: "Communities",
      description: "Communicate with other RCAT users and people in the riverscapes community.",
