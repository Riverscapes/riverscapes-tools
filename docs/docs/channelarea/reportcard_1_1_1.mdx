...
<table>
  <tr>
    <th>Tool</th>
    <td>[Channel Area Tool](https://tools.riverscapes.net/channel)</td>
  </tr>
  <tr>
    <th>Version</th>
    <td>1.1.1</td>
...
| Source Code Documentation | Available at [Github repository](https://github.com/Riverscapes/riverscaps-tools/channel)  | Pass | Source code is clearly organized and documented |
| Open Source | [open-source](https://github.com/Riverscapes/riverscaps-tools/channel) with [GNU General Public License v 3.0](https://github.com/Riverscapes/riverscapes-tools/blob/master/LICENSE) | Pass | |
...
- Making it easy for GIS users to download channel area [projects](https://riverscapes.net/Tools/Technical_Reference/Documentation_Standards/Riverscapes_Projects/) for use in [Viwer](https://viewer.riverscapes.net) 
