...
<ToolsWrapper
  ...
  {
    title: "Channel Area",
    description: "Genters polygons representing the spatial extent of the drainage network within a watershed by buffering flow lines and combining with waterbody polygons.",
    toolUrl: "https://tools.riverscapes.net/channelarea/",
    logoUrl: "/img/logo.png"
  },
  {
    title: "TauDEM",
    description: "A riverscapes compliant wrapper around the Terrain Analysis Using Digital Elevation Models (TauDEM) is a suite of tools developed by David Tarboton at the Utah State University Hydrology Research Group.",
