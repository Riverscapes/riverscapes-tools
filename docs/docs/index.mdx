...
<ToolsWrapper
  ...
  cards={[
    {
      title: "Geomorphic Unit Toolbox",
      description: "Uses topographic evidence to segregate riverscapes into hierarchical geomorphic units such as pools, riffles and glides.",
      toolUrl: "https://gut.riverscapes.net/",
      logoUrl: "/img/logo.png",
    },
    {
      title: "RIM",
      description: "The Riverscapes Inundation Mapper Tool aids in the efficient mapping of structurally forced inundation patterns in beaver impacted riverscapes.",
      toolUrl: "https://gut.riverscapes.net/",
      logoUrl: "/img/logo.png",
    },
  ]}
