...
class CybercastorAPI:
    """This is for Connecting to the CYBERCASTOR API and making queries
    """
    ...
    def auth_query(self):
        result = self.run_query(CybercastorAPI._GQL_Auth, {})  # Execute the query
        return result['data']['auth']  # Drill down the dictionary

    def add_job(self, params):
        result = self.run_query(CybercastorAPI._GQL_AddJob, params)  # Execute the query
    ...
    def get_jobs(self, jobStatus=None, taskStatus=None, limit=None, nextToken=None):
        ...
        result = self.run_query(CybercastorAPI._GQL_GetJobs, {"jobStatus": jobStatus, "taskStatus": taskStatus, "limit": limit, "nextToken": nextToken})  # Execute the query
        return result['data']['getJobs']  # Drill down the dictionary

    def get_job(self, id):
        result = self.run_query(CybercastorAPI._GQL_GetJob, {"id": id})  # Execute the query
        return result['data']['getJob']  # Drill down the dictionary

    def jobs_query(self):
        result = self.run_query(CybercastorAPI._GQL_Jobs, {})  # Execute the query
        return result['data']['programs']  # Drill down the dictionary

    def start_task(self, id):
        result = self.run_query(CybercastorAPI._GQL_StartTask, {"id": id})  # Execute the query
        return result['data']['startTask']

    def stop_task(self, id):
        result = self.run_query(CybercastorAPI._GQL_StopTask, {"id": id})  # Execute the query
